...
public class AddACopyGa : GameAction
{
    ...
    public AddACopyGa(int amount, int MultiplyAmount, DynamicAmount dynamicAmount, Enemy_Player_ENUM affectedSide, CopyTokenType typeOfCopy, List<DynamicConditionInfo> conditionToCopy)
    {
        Amount = amount;
